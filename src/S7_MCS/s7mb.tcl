...
#
# s7mb.tcl: Tcl script for re-creating project 's7mb'
#
# Generated by Vivado on Tue Jan 24 14:04:08 +1100 2023
...
#
# 1. This project restoration tcl script (s7mb.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/robertjo/Documents/other/s7mb/s7mb.srcs/sources_1/new/vs_reg.vhd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/s7mb.srcs/sources_1/new/vs_reg.vhd"]"\
  ]
  foreach ifile $files {
...
set_property -name "top" -value "vs_reg" -objects $obj
set_property -name "top_arch" -value "RTL" -objects $obj
set_property -name "top_file" -value "$proj_dir/s7mb.srcs/sources_1/new/vs_reg.vhd" -objects $obj
...
if { [get_files vs_reg.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/robertjo/Documents/other/s7mb/s7mb.srcs/sources_1/new/vs_reg.vhd
}


# Proc to create BD system_0
proc cr_bd_system_0 { parentCell } {
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  # Create instance: vs_reg_0, and set properties
  set block_name vs_reg
  set block_cell_name vs_reg_0
  if { [catch {set vs_reg_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create port connections
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins vs_reg_0/regs_addr]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_pins axi_bram_ctrl_0/bram_clk_a] [get_bd_pins vs_reg_0/regs_clk]
  connect_bd_net -net axi_bram_ctrl_0_bram_en_a [get_bd_pins axi_bram_ctrl_0/bram_en_a] [get_bd_pins vs_reg_0/regs_en]
  connect_bd_net -net axi_bram_ctrl_0_bram_rst_a [get_bd_pins axi_bram_ctrl_0/bram_rst_a] [get_bd_pins vs_reg_0/regs_rst]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_pins axi_bram_ctrl_0/bram_we_a] [get_bd_pins vs_reg_0/regs_we]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a] [get_bd_pins vs_reg_0/regs_wr_data]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins mdm_0/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins mdm_0/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -net vs_reg_0_regs_rd_data [get_bd_pins axi_bram_ctrl_0/bram_rddata_a] [get_bd_pins vs_reg_0/regs_rd_data]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.14325",
   "Default View_TopLeft":"-127,-45",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port diff_clock_rtl -pg 1 -lvl 0 -x -10 -y 140 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x -10 -y 200 -defaultsOSRD
preplace port port-id_reset_0 -pg 1 -lvl 0 -x -10 -y 80 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 4 -x 1170 -y 280 -defaultsOSRD
preplace inst mdm_0 -pg 1 -lvl 3 -x 730 -y 280 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 5 -x 1600 -y 130 -defaultsOSRD
preplace inst clk_wiz_1 -pg 1 -lvl 2 -x 420 -y 150 -defaultsOSRD
preplace inst rst_clk_wiz_1_100M -pg 1 -lvl 3 -x 730 -y 100 -defaultsOSRD
preplace inst reset_inv_0 -pg 1 -lvl 1 -x 160 -y 200 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 5 -x 1600 -y 550 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 6 -x 1930 -y 550 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 6 -x 1930 -y 330 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 5 -x 1600 -y 340 -defaultsOSRD
preplace inst vs_reg_0 -pg 1 -lvl 7 -x 2310 -y 670 -defaultsOSRD
preplace netloc axi_bram_ctrl_0_bram_addr_a 1 6 1 2120 500n
preplace netloc axi_bram_ctrl_0_bram_clk_a 1 6 1 2110 520n
preplace netloc axi_bram_ctrl_0_bram_en_a 1 6 1 2110 580n
preplace netloc axi_bram_ctrl_0_bram_rst_a 1 6 1 2100 540n
preplace netloc axi_bram_ctrl_0_bram_we_a 1 6 1 N 620
preplace netloc axi_bram_ctrl_0_bram_wrdata_a 1 6 1 2080 540n
preplace netloc clk_wiz_1_locked 1 2 1 540 140n
preplace netloc mdm_1_debug_sys_rst 1 2 2 550 360 900
preplace netloc microblaze_0_Clk 1 2 4 530 380 940 380 1450 30 1770
preplace netloc reset_0_1 1 0 3 NJ 80 NJ 80 NJ
preplace netloc reset_1 1 0 1 NJ 200
preplace netloc reset_inv_0_Res 1 1 1 300J 160n
preplace netloc rst_clk_wiz_1_100M_bus_struct_reset 1 3 2 NJ 80 1460
preplace netloc rst_clk_wiz_1_100M_mb_reset 1 3 1 930 60n
preplace netloc rst_clk_wiz_1_100M_peripheral_aresetn 1 2 4 560 370 910 140 1420 40 1750
preplace netloc vs_reg_0_regs_rd_data 1 6 2 2090J 480 2470
preplace netloc axi_smc_M00_AXI 1 5 1 1760 530n
preplace netloc diff_clock_rtl_1 1 0 2 NJ 140 NJ
preplace netloc microblaze_0_M_AXI_DC 1 4 1 1410 300n
preplace netloc microblaze_0_M_AXI_DP 1 4 1 1440 260n
preplace netloc microblaze_0_M_AXI_IC 1 4 1 1400 320n
preplace netloc microblaze_0_axi_periph_M00_AXI 1 5 1 1760 280n
preplace netloc microblaze_0_axi_periph_M01_AXI 1 2 4 560 200 920J 20 NJ 20 1740
preplace netloc microblaze_0_debug 1 3 1 920 260n
preplace netloc microblaze_0_dlmb_1 1 4 1 1440 100n
preplace netloc microblaze_0_ilmb_1 1 4 1 1430 120n
levelinfo -pg 1 -10 160 420 730 1170 1600 1930 2310 2510
pagesize -pg 1 -db -bbox -sgen -140 0 2510 860
"
}
...
# End of cr_bd_system_0()
cr_bd_system_0 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files system_0.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files system_0.bd ] 
set_property IS_ENABLED "1" [get_files system_0.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files system_0.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files system_0.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files system_0.bd ] 
set_property PFM_NAME "" [get_files system_0.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files system_0.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files system_0.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files system_0.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files system_0.bd ] 
set_property USED_IN_SIMULATION "1" [get_files system_0.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files system_0.bd ] 
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/s7mb.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/s7mb.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/s7mb.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
